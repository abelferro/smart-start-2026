...
const FeatureCard = ({
  ...
  <motion.div
    ...
    className="glass p-8 rounded-[32px] flex flex-col items-start gap-4 hover:scale-[1.02] transition-transform duration-300"
  >
    <div
    ...
    <div className="relative min-h-screen font-sans selection:bg-brand-purple/30">
      ...
      <section className="relative pt-20 pb-16 md:pt-32 md:pb-24 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className="w-8 h-8 rounded-full bg-linear-to-br from-brand-purple to-brand-pink flex items-center justify-center text-white">
              <Heart size={16} fill="currentColor" />
            </div>
            <span className="text-sm font-bold tracking-wide uppercase text-slate-900">
              Partner Hub
            </span>
          </motion.div>
          ...
          >
            Apply for programs, find care, select schools, and communicate with
            providers.
          </motion.p>
          ...
          >
            <div className="p-[2px] rounded-full bg-linear-to-r from-[#2a6bec] via-[#9956b9] via-[#eb4885] via-[#fcc10b] to-[#55c858] shadow-2xl">
              <button
                onClick={scrollToForm}
                className="group relative px-10 py-5 bg-white text-slate-900 rounded-full font-bold text-lg hover:bg-slate-50 transition-all active:scale-95 flex items-center gap-2"
              >
                Get Started
                <ChevronRight
            ...
            <p className="text-sm text-slate-400">No login required to begin</p>
          </motion.div>
        </div>
      </section>

      {/* Families Section */}
      <section className="py-20 px-6 bg-[#eb4885]/5 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-64 h-64 bg-brand-pink/10 blur-[100px] rounded-full -z-10" />
        <div className="max-w-6xl mx-auto">
          <SectionTitle subtitle="Find care, apply for programs, and stay connected with your child's journey.">
            For Families
          </SectionTitle>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="grid gap-6">
              ...
              <motion.button
                ...
                viewport={{ once: true }}
                onClick={scrollToForm}
                className="mt-4 flex items-center gap-2 text-brand-purple font-bold text-lg hover:gap-4 transition-all"
              >
                Apply or Get Started <ArrowRight size={20} />
              </motion.button>
            </div>
              ...
              <div className="flex-1 bg-slate-100 rounded-3xl overflow-hidden relative border border-slate-200">
                ...
                <div className="absolute bottom-4 left-4 right-4 glass p-4 rounded-2xl">
                  ...
                  <p className="text-sm font-medium">
                    32 Providers found in Forsyth County
                  </p>
                </div>
              </div>

              {/* Mock UI: Application Status */}
              <div className="h-32 glass p-6 rounded-3xl flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500">
                    NC Pre-K Program • Today, 10:42 AM
                  </p>
                </div>
              </div>
      ...
      {/* Providers Section */}
      <section className="py-20 px-6 bg-[#2a6bec]/5 relative overflow-hidden">
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-brand-blue/10 blur-[100px] rounded-full -z-10" />
        <div className="max-w-6xl mx-auto">
          <SectionTitle subtitle="Manage attendance, payments, and support families from one centralized system.">
            For Providers
          </SectionTitle>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid gap-6 order-1 md:order-2">
              ...
              <motion.button
                ...
                viewport={{ once: true }}
                onClick={scrollToForm}
                className="mt-4 flex items-center gap-2 text-brand-pink font-bold text-lg hover:gap-4 transition-all"
              >
                Access Provider Tools <ArrowRight size={20} />
              </motion.button>
            </div>
          </div>
        </div>
      ...
      {/* Supporting Section */}
      <section className="py-24 px-6 text-center relative overflow-hidden bg-[#55c858]/5">
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          >
            Connecting families with care to ensure they have the relational and
            concrete supports they need to thrive.
          </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Smart Start of Forsyth County enriches young lives by supporting
            families, caregivers, and providers through high-quality early
            education programs.
          </motion.p>
        </div>
      ...
      >
        ...
        <div className="max-w-xl mx-auto relative z-10">
          <div className="text-center mb-12">
            ...
            >
              Join Partner Hub now to connect and thrive in early childhood
              education.
            </motion.p>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-6 py-4 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-2 focus:ring-brand-purple focus:border-transparent outline-hidden transition-all placeholder:text-slate-400 text-slate-900"
                    value={formData.name}
                    onChange={(e) =>
                ...
                <div className="flex items-start gap-3">
                  <input
                    ...
                    type="checkbox"
                    id="agree"
                    className="mt-1 w-5 h-5 rounded border-slate-200 text-brand-purple focus:ring-brand-purple"
                  ...
                  >
                    ...
                    and Partner Hub updates.
                  </label>
                </div>
                <button
                  type="submit"
                  className="w-full py-5 bg-linear-to-r from-[#2a6bec] via-[#9956b9] via-[#eb4885] via-[#fcc10b] to-[#55c858] text-white rounded-2xl font-bold text-lg shadow-xl hover:opacity-90 transition-all active:scale-95 flex items-center justify-center gap-2 animate-gradient-x"
                >
                  Get Started
                  <ArrowRight size={20} />
                </button>
          ...
          <div className="mt-12 text-center">
            ...
            <div className="pt-12 border-t border-slate-200 flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="flex gap-4">
                <div className="px-4 py-2 rounded-lg bg-white shadow-sm text-xs font-medium text-slate-500">
                  NC Pre-K
                </div>
                <div className="px-4 py-2 rounded-lg bg-white shadow-sm text-xs font-medium text-slate-500">
                  Smart Start
        ...
        <div className="absolute top-0 right-0 w-96 h-96 bg-brand-purple/20 blur-[120px] rounded-full -z-0" />
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-brand-pink/10 blur-[120px] rounded-full -z-0" />
      </section>
    </div>
  );
}
